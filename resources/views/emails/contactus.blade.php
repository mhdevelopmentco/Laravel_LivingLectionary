                                ...
                                <tr>
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <td>
                                                    <h2>We have Received Contact Request</h2>
                                                </td>
                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <center data-parsed="">
                                                        <a href="<?php echo url('');?>" align="center"
                                                           class="text-center">
                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <center data-parsed="">
                                                        <img src="<?php echo url('');?>/public/assets/email/contact_received.jpg"
                                                             valign="bottom" alt="Password Recovery Image" align="center"
                                                             class="text-center">
                                                    </center>
                                                </th>
                                                <th class="expander"></th>
                                ...
                                <tr> <!-- Main Email content -->
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <h5>We have received new Contact Request.</h5>
                                                </th>
                                            </tr>
                                        </table>
                                    </th>
                                ...
                                <tr>
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <p class="text-center footercopy">&#xA9; Copyright <?php echo date("Y"); ?> Living Lectionary.
