                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <center data-parsed="">
                                                        <a href="<?php echo url('');?>/index#login" align="center"
                                                           class="text-center">
                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <center data-parsed="">
                                                        <img src="<?php echo url('');?>/public/assets/email/password_recovery.jpg"
                                                             valign="bottom" alt="Password Recovery Image"
                                                             align="center"
                                                             class="text-center">
                                                    </center>
                                                </th>
                                ...
                                <tr> <!-- This container adds the gap between digest content and CTA  -->
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <a href="{{url('unsubscribe_from_newsletter').'/'.$userid}}">Unsubscribe</a>
                                                </th>
                                                <th class="expander"></th>
                                            </tr>
                                        </table>
