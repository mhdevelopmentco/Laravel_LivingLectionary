...
@section('title', 'Edit Merchant Account')
@section('css')
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a>Edit Merchant Account</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
            ...
            <div class="box dark">
                ...
                <div class="row">
                    <div class="col-md-11 panel_marg" style="padding-bottom:10px;">
                        ...
                        {!! Form::open(array('url'=>'edit_contributor_submit_in_merchant','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="select_mer_country">Select Country<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="select_mer_state">Select State<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="select_mer_city">Input City<span
                                                class="text-sub">*</span></label>
