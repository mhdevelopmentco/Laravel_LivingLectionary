    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a>Edit Shop Account</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="text1">Store Owner</label>
                                    <div class="col-md-4">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="hidden" name="mem_id" value="<?php echo $merchant_id; ?>" ?>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="text1">Country<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="select_state">State<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="select_city">City<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="store_add_one">Address1<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="store_add_two">Address2</label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="zip_code">Zipcode<span
                                                class="text-sub">*</span></label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="meta_keyword">Meta keywords</label>
                                    ...
                                    <div class="col-md-8">
                                        <label style="display: inline-block;">
                                            <input type="radio" style="margin-left:10px;" name="show_map" value="1"
                                                   @if($store_details->stor_show_map == 1)checked @endif>Yes
                                        </label>
                                        <label style="display: inline-block;">
                                            <input type="radio" style="margin-left:10px;" name="show_map" value="0"
                                                   @if($store_details->stor_show_map == 0)checked @endif>No
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="store_commission">Store
                                        Commission</label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="text1">Store Image<span
                                                class="text-sub">*</span></label>
