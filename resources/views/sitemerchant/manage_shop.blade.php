    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a> Manage Shop </a></li>
            </ul>
        </div>
    </div>
    <div class="row">
                    ...
                    <div role="grid" class="dataTables_wrapper form-inline"
                        ...
                        <table aria-describedby="dataTables-example_info"
                            ...
                            <tr class="gradeA odd">
                                ...
                                <td class="text-center">
                                    <a href="<?php echo url('merchant_edit_shop/' . $store_details->stor_id . "/" . $store_details->stor_merchant_id); ?>">
                                        <i class="icon icon-edit icon-2x"></i>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo url('merchant_delete_shop/' . $store_details->stor_id . "/" . $store_details->stor_merchant_id); ?>">
                                        <i class="icon icon-trash icon-2x"></i>
                                    </a>
                                </td>
                                <td class="text-center ">
                                    <?php if($store_details->stor_status == 1) { ?>
                                    <a href="<?php echo url('merchant_block_shop/' . $store_details->stor_id . "/0" . "/" . $store_details->stor_merchant_id); ?>"><i
                                                class="icon icon-ok icon-2x "></i></a>
                                    <?php } else if($store_details->stor_status == 0) { ?>
                                    <a href="<?php echo url('merchant_block_shop/' . $store_details->stor_id . "/1" . "/" . $store_details->stor_merchant_id); ?>"><i
