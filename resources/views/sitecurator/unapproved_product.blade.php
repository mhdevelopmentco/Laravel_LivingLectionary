...
@section('title', 'UnApproved Resources')
@section('css')
    <style>
        .text-center a .icon {
            margin: 0 7px;
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                @if($type == \App\Products::PRODUCT_STATUS_PENDING)
                    <li class="active"><a> Pending Resources </a></li>
                @else
                    <li class="active"><a> Disapproved Resources </a></li>
                @endif
            </ul>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="box dark">
                <header>
                    ...
                    @if($type == \App\Products::PRODUCT_STATUS_PENDING)
                        <h5> Pending Resources </h5>
                    @else
                        <h5> Disapproved Resources </h5>
                    @endif
                </header>
                        ...
                        <table id="dataTables-example"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example"
                                    ...
                                    aria-label="Unapproved At: activate to sort column ascending">Unapproved At
                                </th>
                            </tr>
                            </thead>
                            <tbody>
