...
<!-- Sidebar end=============================================== -->
    ...
    <li><i class="icon-comment-alt"></i><a href="<?php echo url('blog_comment/'. $fetchblog_list->blog_id); ?>"  style="color:#F00;"> <?php echo $get_blog_list_count[$fetchblog_list->blog_id];  ?>  Comments</a></li>
    ...
    <div class="span4">  
			<img src="<?php echo url(); ?>/public/assets/images/blogimage<?php echo $fetchblog_list->blog_image; ?>" width="320" height="190">
            </div>
