...
@section('title', 'Resource Ship Orders')
@section('css')
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a>Orders to be Shipped</a></li>
            </ul>
        </div>
    </div>

    <div class="row">
        {!! Form::open(['action'=>'TransactionController@resource_ship_orders']) !!}
        ...
        <div class="col-md-12">
            <div class="box dark">
                <header>
                    ...
                    <h5>Resource Orders to be Shipped</h5>
                </header>
                    ...
                    <div role="grid" class="dataTables_wrapper form-inline"
                        ...
                        <table id="dataTables-example"
                            ...
                            <tr role="row">
                                ...
                                <th class="text-center">Resource Delivered Status</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i = 1;?>
                            @forelse($orders as $order)
                                ...
                                $row_span_count = count($order_products);
                                $first = true;
                                ?>
                                @foreach( $order_products as $product)
                                    @if($first)
                                        <tr class="gradeA odd">
                                            ...
                                            <td class="text-center" rowspan="{{$row_span_count}}">
                                                @if($order->payout_to_merchant_status)
                                                    <i class="icon-ok"></i>
                                                @else
                                                    <i class="icon-remove"></i>
                                                @endif
