                    ...
                    @foreach($edit_secsub_catg_details as $add_sub_catg_det)
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="catg_name" placeholder="" name="catg_name" class="form-control" readonly
                                       value=" {!!$add_sub_catg_det->mc_name!!} / {!!$add_sub_catg_det->smc_name!!}" type="text"> <input type="hidden"
                                                                                                     id="catg_id"
                                                                                                     name="catg_id"
                                                                                                     value="{!!$add_sub_catg_det->sb_id!!}"/>
                                <input type="hidden" id="main_catg_id" name="main_catg_id"
                                       value="{!!$add_sub_catg_det->smc_id !!}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="main_catg_name" placeholder="" name="main_catg_name" class="form-control"
                                       value="{!!$add_sub_catg_det->sb_name !!}" type="text"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <a href="<?php echo url('manage_sub_category');?>/{!!$add_sub_catg_det->smc_id !!}"
