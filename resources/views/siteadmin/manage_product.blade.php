...
@section('content')
        ...
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                @if( isset($type) && ($type == 1) )
                    <li class="active"><a> Manage Pending or Approved Resources </a></li>
                @else
                    <li class="active"><a> Manage Dispproved Resources </a></li>
                @endif
            </ul>
        </div>
    </div>
    ...
    @if( isset($type) && ($type == 1) )
        {!! Form::open(array('url'=>'manage_pending_approved_product', 'class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
    @else
        {!! Form::open(array('url'=>'manage_disapproved_product', 'class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
    @endif
        ...
        <div class="col-md-12">
            <div class="box dark">
                ...
                <div id="div-1" class="accordion-body collapse in body">
                    ...
                    <td role="grid" class="dataTables_wrapper form-inline"
                        ...
                        <table id="dataTables-example"
                            ...
                            if ($product->pro_status == 1) {
                                $process = "<a href='" . url('block_product/' . $product->pro_id . '/0') . "' > <i class='icon icon-ok icon-me'></i> </a>";
                            } else if ($product->pro_status == 0) {
                                $process = "<a href='" . url('block_product/' . $product->pro_id . '/1') . "' > <i class='icon icon-ban-circle icon-me'></i> </a>";
                            }
                            ...
                            <tr class="gradeA odd">
                                ...
                                <td class="text-center action_td">
                                    <a href="<?php echo url('edit_product/' . $product->pro_id); ?>">
                                        <i class="icon icon-edit"></i>
                                    </a>
                                    <?php echo $process; ?>
                                    <a href="<?php echo url('delete_product') . "/" . $product->pro_id; ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo url('set_trending_product') . '/' . $product->pro_id . '/' . '0'; ?>">
                                        <i class="icon-heart icon-1x icon-me"></i>
                                    </a>
                                    <?php } else { ?>
                                    <a href="<?php echo url('set_trending_product') . '/' . $product->pro_id . '/' . '1'; ?>">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo url('set_present_product') . '/' . $product->pro_id . '/' . '0'; ?>">
                                        <i class="icon-star icon-1x icon-me"></i>
                                    </a>
                                    <?php } else { ?>
                                    <a href="<?php echo url('set_present_product') . '/' . $product->pro_id . '/' . '1'; ?>">
                                ...
                                <td class="text-center">
                                    <a href="<?php echo url('product_details') . "/" . base64_encode($product->pro_id); ?>">View
                                        details</a>
                                </td>
                            </tr>
                            <?php
