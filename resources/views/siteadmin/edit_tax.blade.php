    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a>Edit Tax</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
            ...
            <div class="box dark">
                ...
                <div class="row">
                    <div class="col-md-11 panel_marg" style="padding-bottom:10px;">
                        ...
                        {!! Form::open(array('url'=>'edit_tax_submit','class'=>'form-horizontal')) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="validate[required] form-control" id="country_name"
                                        ...
                                        onChange="select_state_from_country(this.value, '<?php echo url('select_state_by_country'); ?>', 'state_name', '<?php echo $tax->tax_st_id;?>' )">

                                    <option value="">--select country--</option>
                                    @foreach($country_details as $country_det)
                                        @if($country_det->co_id == $tax->tax_co_id)
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-4">
                                ...
                                <input type="text" class="form-control" placeholder="" required aria-describedby="basic-addon1"
                                       value="{{ $tax->tax_amount }}" name="tax_amount"
                                       id="tax_amount">
                            </div>
                        </div>
                        <div class="form-group">
