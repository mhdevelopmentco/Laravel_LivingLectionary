    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a>Add Theme</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
            ...
            <div class="box dark">
                ...
                <div class="row">
                    <div class="col-md-11 panel_marg" style="padding-bottom:10px;">
                        ...
                        {!! Form::open(array('url'=>'add_affirmation_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2" for="file">
                                Banner Image<span class="text-sub">*</span>
                            </label>

                            <div class="col-md-4">
                                <input type="file" id="file" name="file" placeholder="Theme Bannner Image" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" id="file2" name="file2" placeholder="Theme Gallery Image" required>
                                Image upload size 400 X 300
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-2" for="theme_heading">Heading
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" placeholder=""
                                       ...
                                       required value="{!! Input::old('theme_heading') !!}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                         <textarea id="theme_description" class="form-control" rows="10"
                                                   ...
                                                   required>{!! Input::old('theme_description') !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2">Choose Resource</label>
                            <div class="col-md-8">
