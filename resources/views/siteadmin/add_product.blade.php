        ...
        <div class="col-md-12">
            <div class="box dark">
                ...
                <!--div class="form-group">
                    ...
                    <div class="form-group product-content ship-product" style="" id="showshipselection"  style="display:none;">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="Select_Merchant">Select Merchant<span
                                    class="text-sub">*</span></label>

                        <div class="col-md-8">
                            <select class="form-control" name="Select_Merchant" id="Select_Merchant" required
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="Select_Shop">Select Shop<span
                                    class="text-sub">*</span></label>
