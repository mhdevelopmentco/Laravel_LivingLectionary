    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a> Manage Sub Themes </a></li>
            </ul>
        </div>
    </div>
    <div class="row">
                ...
                <div class="accordion-body collapse in body" id="div-1">
                    ...
                    <div role="grid" class="dataTables_wrapper form-inline"
                        ...
                        <table aria-describedby="dataTables-example_info"
                            ...
                            <?php
                            $i = 1;
                            foreach($themeresult as $theme_details) {
                            ?>
                            <tr class="gradeA odd">
                                ...
                                <td class="text-center">
                                    <a href="<?php echo url('edit_sub_affirmation' . '/' . $theme_details->theme_id); ?>">
