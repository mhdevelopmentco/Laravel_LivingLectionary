    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a>Add Third Category</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="catg_name" placeholder="" name="catg_name" class="form-control"
                                       value="{!!$add_sub_catg_det->mc_name!!} / {!!$add_sub_catg_det->smc_name!!}" type="text" readonly>
                                <input type="hidden"  id="catg_id"  name="catg_id" value="{!!$add_sub_catg_det->smc_id!!}"/>
                                <input type="hidden" id="main_catg_id" name="main_catg_id"
                                       value="{!!$add_sub_catg_det->smc_mc_id!!}"/>
                            </div>
                        </div>
