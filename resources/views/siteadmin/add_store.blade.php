...
@section('title', 'Add Merchant Store')
@section('css')
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><a href="#">Add Merchant Store</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-11 panel_marg" style="padding-bottom:10px;">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="store_orgdesc">Organization description</label>

                                    <div class="col-md-10">
                                                <textarea id="store_orgdesc" name="store_orgdesc" rows="10"
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="text1">Store Commission</label>

                                    <div class="col-md-10 input-group">
                                        <input type="text" class="form-control" placeholder="" id="store_commission"
                                               name="store_commission" pattern = "[0-9]+(\\.[0-9]+)?" value="{!! Input::old('store_commission') !!}">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" id="file" name="file" placeholder="Store Image">Image
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <button class="btn btn-default btn-sm btn-grad" type="reset"><a style="color:#000">Reset</a>
                                </button>
