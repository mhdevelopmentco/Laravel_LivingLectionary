            ...
            <div class="box dark">
                ...
                <div class="row">
                    <div class="col-md-11 panel_marg" style="padding-bottom:10px;">
                        ...
                        {!! Form::open(array('url'=>'edit_sub_affirmation_submit','class'=>'form-horizontal','enctype'=>'multipart/form-data')) !!}
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" class="form-control" name="parent_theme_id"
                                       value="{!! $theme_details->parent_theme !!}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="hidden" name="file_old" value="{!! $theme_details->theme_banner_img !!}"/>
                                <input type="file" id="file" name="file" placeholder="Theme Bannner Image">
                                <br>
                                @if($theme_details->theme_banner_img)
